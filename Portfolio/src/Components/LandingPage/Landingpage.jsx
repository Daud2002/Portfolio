...
export default function Landingpage() {
    ...
    return (
        <div className='flex md:flex-row flex-col-reverse'>
            <div className='flex items-center justify-center flex-col gap-4 md:w-[50%]'>
                ...
                <div className='flex flex-row justify-around w-[100%] mt-8'>
            ...
            <div className='flex items-center justify-center md:w-[50%] w-[100%]'>
